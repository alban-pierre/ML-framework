...
if example_1:
    ...
    train_monitors = [Train_Error(2500), Test_Error(valloader, 6250), Save_Net(12500)]
    res = train(net, trainloader, criterion, optimizer, nbr_epochs=1, train_monitors=train_monitors, resume=res)
...
if example_3:
    ...
    train_monitors = [Train_Error(10),
                      ...
                      # Net_Parameters_Change(5000),
                      # Show_Conv_Filters(2500)]
    res = train(net, trainloader, criterion, optimizer, nbr_images=100, train_monitors=train_monitors, resume=res)
